...
let TeacherAttendanceController = class TeacherAttendanceController {
    ...
    toggleAttendance(req, sessionId, body) {
        return this.attendanceService.toggleAttendance(req.user.email, sessionId, body?.attended);
    }
};
...
], TeacherAttendanceController.prototype, "getAttendance", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TeacherAttendanceController.prototype, "toggleAttendance", null);
