...
exports.TeacherRlpController = void 0;
const common_1 = require("@nestjs/common");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
const roles_decorator_1 = require("../auth/roles.decorator");
const roles_guard_1 = require("../auth/roles.guard");
const update_rlp_session_dto_1 = require("./dto/update-rlp-session.dto");
const rlp_service_1 = require("./rlp.service");
let TeacherRlpController = class TeacherRlpController {
    rlp;
    constructor(rlp) {
        this.rlp = rlp;
    }
...
exports.TeacherRlpController = TeacherRlpController = __decorate([
    (0, common_1.Controller)('teacher/rlp-sessions'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('GV'),
    __metadata("design:paramtypes", [rlp_service_1.RlpService])
], TeacherRlpController);
//# sourceMappingURL=teacher-rlp.controller.js.map