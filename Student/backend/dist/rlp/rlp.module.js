...
exports.RlpModule = RlpModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        controllers: [student_rlp_controller_1.StudentRlpController, teacher_rlp_controller_1.TeacherRlpController],
        providers: [rlp_service_1.RlpService],
        exports: [rlp_service_1.RlpService],
    })
], RlpModule);
